...
public class NioServer2 implements Runnable {
     ...
     */
    protected NioServer2(InetSocketAddress address) throws IOException {
                ...
                while (i.hasNext()) {
                    ...
                    try {
                        ...
                        if (key.isAcceptable()) {
                            ...
                            // create it if it doesnt existimport java.nio.charset.Charset;
                            if (session == null) {
    ...
    public static void main(String[] args) throws Exception {
        NioServer2 server = new NioServer2(new InetSocketAddress(5555));
        while (true) {
            server.run();
            Thread.sleep(100);
        }
